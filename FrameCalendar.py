...
class FrameCalendar():
    ...
    def __init__(self, master):
        ...
        labelframe = tk.LabelFrame(self.master.master, text="  Calendar  ", font="Helvetica 11 bold", bd=3,
                                   labelanchor="n")
        ...
        self.dynamic_label = tk.Label(self.tasks, textvariable=self.staticText, font="Helvetica 15 bold").pack(
            side="top")
        ...
        self.listBox = tk.Listbox(self.tasks, font="Helvetica 12")
